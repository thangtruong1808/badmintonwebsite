...
-- =====================================================
-- Table: play_slots
-- Stores recurring social play slot templates
-- =====================================================
...
-- =====================================================
-- Table: courts
-- Stores court labels per recurring play slot
-- =====================================================
...
CREATE TABLE IF NOT EXISTS registrations (
    ...
    status ENUM('pending', 'confirmed', 'cancelled', 'pending_payment') NOT NULL DEFAULT 'pending',
...
-- Stores individual guest names per registration
-- =====================================================
...
-- Stores users waiting for spots
-- =====================================================
...
-- Pay-before-join waitlist for new spots
-- =====================================================
...
-- =====================================================
-- Table: pending_add_guests
-- Pay-before-join waitlist for adding guests to existing registration
-- =====================================================
...
-- Stores quantity-based pricing per product
-- =====================================================
...
-- Stores string types for stringing service
-- =====================================================
...
-- Single row config for service flyer URL
-- =====================================================
...
-- =====================================================
-- Table: disputes
-- Stores Stripe dispute/chargeback records for tracking
-- =====================================================
...
-- =====================================================
-- Table: vets_events
-- Admin-managed list of VETS events
-- =====================================================
...
-- =====================================================
-- Table: vets_interests
-- Player sign-ups for VETS events
-- =====================================================
