            ...
            {isSetPasswordMode ? (
              <form onSubmit={handleSetPasswordSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className={`w-full bg-rose-500 hover:bg-rose-600 text-white font-bold py-3 px-6 rounded-lg transition duration-300 font-calibri text-lg flex items-center justify-center gap-2 ${isSettingPassword ? "opacity-70 cursor-not-allowed" : ""
                    }`}
                >
                  {isSettingPassword ? (
                    <>
              ...
              <form onSubmit={handleResetSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className={`w-full bg-rose-500 hover:bg-rose-600 text-white font-bold py-3 px-6 rounded-lg transition duration-300 font-calibri text-lg flex items-center justify-center gap-2 ${isResetting ? "opacity-70 cursor-not-allowed" : ""
                    }`}
                >
                  {isResetting ? (
                    <>
